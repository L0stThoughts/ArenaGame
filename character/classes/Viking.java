...
public class Viking extends Character{
    ...
    public Viking(String name, int LVL, int STR, int INT, int AGI, int DEF, int XP, RaceProperties race){
        super(name, STR, INT, AGI, DEF, LVL, XP, race);
    } 

    public Viking(String name, int STR, int INT, int AGI, int DEF, RaceProperties race){
